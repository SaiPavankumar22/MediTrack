    ...
    <div className="space-y-20">
      ...
      <section className="text-center py-20">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-center space-x-4 mb-8">
            <div className="p-4 bg-gradient-to-r from-blue-500 to-green-500 rounded-3xl shadow-lg">
              <Stethoscope className="h-12 w-12 text-white" />
            </div>
            <div className="text-left">
              <h1 className="text-5xl font-extrabold bg-gradient-to-r from-blue-600 to-green-600 bg-clip-text text-transparent">
                MediTrack Lite
              </h1>
      ...
      <section className="py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <FeatureCard
            ...
            description="Optimized performance ensures quick loading times and smooth interactions across all devices and platforms."
      ...
      <section className="py-20 bg-white/50 dark:bg-slate-800/50 rounded-3xl backdrop-blur-sm border border-gray-200 dark:border-slate-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <StatCard number="50,000+" label="Appointments Booked" />
      ...
      <section className="py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <StepCard
            ...
            description="Book appointments with preferred doctors, select time slots, and add health concern notes."
            icon={<Calendar className="h-12 w-12" />}
          />
          <StepCard
            step="3"
            title="Manage & Track"
            description="Monitor appointment status, receive updates, and maintain comprehensive health records."
      ...
      {/* CTA Section */}
      <section className="py-20 text-center bg-gradient-to-r from-blue-500 to-green-500 rounded-3xl text-white">
        <div className="max-w-4xl mx-auto px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/register"
              className="inline-flex items-center px-8 py-4 text-lg font-semibold rounded-2xl bg-white text-blue-600 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-white/30 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
              Start Free Trial
              <ArrowRight className="ml-2 h-5 w-5" />
            </Link>
...
const FeatureCard: React.FC<FeatureCardProps> = ({ icon, title, description, gradient }) => {
  return (
    <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl p-8 border border-gray-200 dark:border-slate-700 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group">
  ...
  return (
    <div className="text-center group">
      <div className="relative mb-8">
        <div className="w-24 h-24 mx-auto bg-gradient-to-r from-blue-500 to-green-500 rounded-full flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300">
          {icon}
        </div>
